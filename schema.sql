...
CREATE TABLE IF NOT EXISTS vessel_status (
    ...
    average_speed_ms DOUBLE NOT NULL COMMENT 'Average speed over reporting period in meters/second',
    max_speed_ms DOUBLE NOT NULL COMMENT 'Maximum speed over reporting period in meters/second',
