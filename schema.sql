...
CREATE TABLE IF NOT EXISTS vessel_status (
    ...
    average_wind_speed_kn DOUBLE COMMENT 'Average wind speed over reporting period in knots (NULL if no wind data)',
    average_wind_angle_deg DOUBLE COMMENT 'Average wind direction over reporting period in degrees (NULL if no wind data)',
